...
//Визуальная часть страницы    классы типа MainView
...
class MainView extends AbstractView {
    ...
    render() {
        ...
        main.innerHTML = `
            <h1>Найдена книг - ${this.state.numFound}</h1>
        `;
...
//State  данные приложения в текущий момент appState и state внутри MainView

//Реактивность  автоматическое обновление интерфейса при изменении данных  БИБЛИОТЕКА on-change
...
//Роутинг  механизм переключения между страницыами без перезагрузки   КЛАСС  App с массивом routes
class App {
    routes = [
        { path: "", view: MainView },
